...
import VideoSlide11 from "~/components/Layout/VideoSlide11";
let timeoutIDs: any = [];
const videoOverlayTimeoutIds = { current: null };
const Content11 = (props: {
  videoData: any;
  ref1?: any;
  ref2?: any;
  catId?: number;
  ...
  console.log("video data from content",props.videoData)
                    ...
                    return (
                      ...
                      >
                        <VideoSlide11
                          ...
                          show={d["media:show"]?d["media:show"]:"" }
                          title={decodeURIComponent(escape(d.title))}
                          videoID={d.id}
                          link={d.link}
                          urltitle={d.title}
                          channel_id={d["media:source_id"]?d["media:source_id"]:""}
                          index={index}
