          ...
          <div className="LogSd_tb-cnt-wr">
              ...
              <div className="LogSd_comn-wr">
                <div className="LogSd_logo-wr">
                  <a className="LogSd_logo" href="javascript:void(0);">
                    <svg className="vj_icn vj_logo-ndtv lg" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 365 68.9" style={{enableBackground: 'new 0 0 365 68.9'}} xmlSpace="preserve">
                      <g id="XMLID_1_">
                        <path id="XMLID_3_" className="st0" d="M0,0.1c8.4,0,16.8-0.1,25.2,0C35.2,0.7,44,7.4,48.8,16c4.8,9.1,9,18.5,13.9,27.5   c1.6,3.2,4.8,5.4,8.4,5.5C70.9,32.7,71,16.4,71,0c7.4,0.1,14.7,0,22.1,0c0,7.1,0,14.2-0.1,21.4c-5.1,2-9.4,6.5-9.5,12.2   c-0.7,6.2,3.9,11.8,9.5,13.7c0.1,7.2,0,14.3,0.1,21.5c-7.3,0.1-14.7,0-22,0.1c-8.5,0.4-16.9-3.5-22.3-9.9   c-6-7.3-9.1-16.5-13.6-24.6C32.1,28.6,29.9,20,22,19.7c0,16.4-0.1,32.7,0.1,49.1c-7.4,0.1-14.7,0.1-22.1,0C0.1,45.9,0.1,23,0,0.1z" style={{fill: 'var(--vj-cl-dr)'}} />
                        <path id="XMLID_6_" className="st0" d="M99.6,0.1c62.4,0,124.7-0.2,187.1,0.1c9.3,16.9,18.8,33.7,28,50.6c9.2-16.8,17.7-34,26.8-50.8   c7.8,0.1,15.6-0.1,23.5,0.2c-1.3,1.9-2.6,3.8-3.7,5.8c-11,21-22.1,41.9-33.2,62.8c-8.9,0-17.9,0-26.8,0   c-9.7-17.5-19.6-35-29.2-52.5c-9.8-0.1-19.7,0-29.5,0c0,17.5,0.1,35,0,52.5c-7.1,0-14.1,0-21.2,0c0-17.5,0.1-35,0-52.6   c-10.8,0.1-21.7,0-32.5,0.1c2,7.5,1.8,15.3,1.5,23c-0.3,7.8-2.4,16.2-8.2,21.8c-5.6,5.8-14,7.8-21.8,7.7   c-20.2-0.1-40.4,0.1-60.5-0.1c0.1-7.2,0-14.3,0.1-21.4c4.8-1.9,8.9-5.8,9.4-11.2c1-6.5-3.5-12.6-9.4-14.7   C99.6,14.3,99.8,7.2,99.6,0.1 M121.1,16.5c0.2,12,0.1,23.9,0.1,35.9c12.1,0.2,24.2,0.1,36.2,0.1c4.7,0.2,10.3-2.4,11-7.6   c0.4-6.7,0.3-13.4,0.1-20.1c-0.5-5.4-6.1-8.4-11.1-8.3C145.3,16.3,133.2,16.2,121.1,16.5z" style={{fill: 'var(--vj-cl-dr)'}} />
                        <path id="XMLID_7_" className="st1" d="M83.5,33.6c0.1-5.7,4.4-10.3,9.5-12.2c2.2-0.2,4.5-0.2,6.7,0c5.9,2.2,10.4,8.2,9.4,14.7   c-0.4,5.3-4.6,9.3-9.4,11.2c-2.2,0.2-4.5,0.2-6.7,0C87.4,45.4,82.8,39.9,83.5,33.6z" style={{fill: '#ee0000'}} />
                      </g>
                    </svg>
                  </a>
                </div>
                <div className="LogSd_txt-wr">
                  <div className="LogSd_txt">Get access to our features, more personalised to
                    experience and newsletters.</div>
                </div>
                <div className="LogSd_frm">
                    ...
                    <div className="LogSd_frm-cn">
                      ...
                      <div className="LogSd_inp">
                        <div className="LogSd_ph-cnt">
                          <div className="LogSd_cntry-code" id="contry-code"> +91 <svg className="count-icn vj_icn vj_arrow-down">
                              <use xlinkHref="#vj_arrow-down" />
                            </svg></div>
                          <input type="text" className="LogSd-inp" placeholder="Enter mobile or email id" id="number" />
                        </div>
                        <span className="vld" style={{xdisplay: 'none'}}>
                          <svg className="vj_icn vj_check">
                            <use xlinkHref="#vj_check" />
                          </svg>
                        </span>
                        <span className="vld in-vld" style={{display: 'none'}}>
                          <svg className=" vj_icn vj_close">
                            <use xlinkHref="#vj_close" />
                          </svg>
                        </span>
                        <div className="LogCty_drop">
                          <div className="LogCty-srch">
                            <div className="LogCty-srch_cn"><input placeholder="Select Country" autoComplete="off" type="text" id="usr" aria-label="search country" className="LogCty-srch_inp" auto-id="true" defaultValue />
                              ...
                              <a className="LogCty-srch_cls" href="javascript:void(0);">
                                <svg className=" vj_icn vj_close">
                                  <use xlinkHref="#vj_close" />
                                </svg>
                              </a>
                          ...
                          <ul className="LogCty_drop-ul">
                            <li className="LogCty_drop-li">
                              <p className="contry-nm">Australia</p><span className="contry-cd">+61</span>
                            </li>
                            <li className="LogCty_drop-li">
                              <p className="contry-nm">Bangladesh</p><span className="contry-cd">+880</span>
                            </li>
                            <li className="LogCty_drop-li">
                              <p className="contry-nm">Ethiopia</p><span className="contry-cd">+251</span>
                            </li>
                            <li className="LogCty_drop-li">
                              <p className="contry-nm">France</p><span className="contry-cd">+33</span>
                            </li>
                            <li className="LogCty_drop-li">
                              <p className="contry-nm">Germany</p><span className="contry-cd">+49</span>
                            </li>
                            <li className="LogCty_drop-li">
                              <p className="contry-nm">India</p><span className="contry-cd">+91</span>
                            </li>
                            <li className="LogCty_drop-li">
                              <p className="contry-nm">Israel</p><span className="contry-cd">+972</span>
                            </li>
                            <li className="LogCty_drop-li">
                              <p className="contry-nm">Malaysia</p><span className="contry-cd">+60</span>
                            </li>
                          </ul>
                        </div>
                      </div>
                  ...
                  <div className="LogSd_otp-txt">We'll send you an OTP to verify.</div>
                  <div className="LogSd_btn-wr"><button className="LogSd_sub-btn l oader" disabled><span>Continue</span>
                  ...
                  <div className="LogSd_sep"><span>Or Continue with</span></div>
                  ...
                  <div className="LogSd_trm">
                    By signing in or creating an account, you agree with NDTV <a href="#" className="LogSd_trm-lnk">Terms &amp; Conditions</a> and <a href="#" className="LogSd_trm-lnk">Privacy Policy.</a>
                    <div className="LogSd_nl">
                      <input id="one" type="checkbox" className="log-nws" defaultChecked />
                      <label htmlFor="one">
                        <span />
            ...
            <div id="LogSd-2" className="LogSd_tb-cnt">
              ...
              <div className="LogSd_comn-wr">
                ...
                <div className="LogSd_frm">
                  <div className="LogSd_frm-col">
                    <div className="LogSd_frm-lbl">OTP Verfication send to
                      <span>XXXXXXX125</span>
                      <a href="#">Edit</a>
                    </div>
                  </div>
                  <div className="LogSd_otp-vrfy">
                    <div className="LogSd_otp-col"> <input type="text" className="LogSd_otp-inp" placeholder="-" id="number" /> </div>
                    <div className="LogSd_otp-col"> <input type="text" className="LogSd_otp-inp" placeholder="-" id="number" /> </div>
                    <div className="LogSd_otp-col"> <input type="text" className="LogSd_otp-inp" placeholder="-" id="number" /> </div>
                    <div className="LogSd_otp-col"> <input type="text" className="LogSd_otp-inp" placeholder="-" id="number" /> </div>
                    <div className="LogSd_otp-col"> <input type="text" className="LogSd_otp-inp" placeholder="-" id="number" /> </div>
                    ...
                    <div className="LogSdAcc_cn">
                      ...
                      <div className="LogSdAcc_mid">
                        <div className="LogSdAcc_mid-wr">
                          ...
                          <div className="LogSdAcc_txt">Manage your account, explore
                            personalized content, save or bookmark stories, discover
                            our
                            newsletters and more.</div>
                        </div>
                        <div className="LogSdAcc_lst-lk-wr">
                          <div className="LogSdAcc_lst-ttl">Get Support </div>
                          <ul className="LogSdAcc_lst-ul">
                            <li className="LogSdAcc_lst-li"> <a href="mailto:login-support@ndtv.com" className="LogSdAcc_lst-lk">Contact Us</a> </li>
                          </ul>
                        </div>
                      </div>
                      <div className="LogSdAcc_btn-wr"> <a href="javascript:void(0);" className="_signoutv LogSdAcc_btn">Log Out</a> </div>
                    </div>
                  </div>
                </div>
              </div>
  ...
  <svg aria-hidden="true" style={{position: 'absolute', width: 0, height: 0, overflow: 'hidden'}} version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
    <defs>
      ...
      <symbol id="vj_arrow-down" viewBox="0 0 32 32">
        ...
        <path d="M29.246 7.663l-13.245 13.248-13.245-13.249c-0.631-0.631-1.653-0.631-2.284 0-0.63 0.631-0.63 1.655 0 2.286l14.386 14.391c0.63 0.631 1.653 0.631 2.283 0l14.386-14.391c0.63-0.631 0.63-1.656 0-2.288-0.628-0.628-1.651-0.628-2.281 0.003z">
        </path>
      </symbol>
