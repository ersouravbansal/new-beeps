...
const MoreSwipe = () => {
  ...
  const src1 = `https://social.ndtv.com/static/Comment/Widget/?key=ff1cab5239e6ac7906dd7848efba52cd&link=${cmnt_Link}&title=${cmnt_Title}&ctype=video&identifier=video-${cmnt_VideoId}&enableCommentsSubscription=1&ver=1&reply=1&sorted_by=likes&template=slide_new&nodomain=1&fordm=1&dm=1`;
  // const src1 =
